...
The [SQL file](sql/cx_kpi_queries.sql) includes checks for duplicate IDs, missing related records, invalid survey values, and inconsistent response and resolution times. These checks should be rerun whenever the input changes.
...
![Power BI Overview showing customer support KPIs](screenshots/CX_Overview.png)
...
![Power BI Trends with Billing & Payments selected](screenshots/CX_Trends.png)
